...
import { YoutubePanel } from "@/components/music-business/YoutubePanel";

function MusicBusinessYoutubePageInner() {
...
export default function MusicBusinessYoutubePage() {
  return (
    <Suspense
      fallback={
